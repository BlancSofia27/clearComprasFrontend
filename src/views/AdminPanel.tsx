...
const AdminPanel: React.FC = () => {
  return (
    <>
    <div className="flex justify-between items-center flex-row p-2 bg-slate">
      <h1 className="xs:text-xs xl:text-2xl font-bold  text-white mx-2 justify-center">Panel de Administración</h1>
